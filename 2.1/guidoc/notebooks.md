...
To change the default name of new notebooks, see the [New Notebook Prefixes](settings.html#new-notebook-prefixes) section in the Settings panel.
...
You can save your notebook at any time by clicking the <img style="margin: 0;float: none;display: inline;" src="img/header_save.png" /> icon in the header bar.
...
Use the second tab of the protection dialog to create or rename groups. Additionally, you can designate other users as group administrators or members. Alternatively, you can select Manage Groups from the Advanced menu item on [the header bar](headerbar.html#header-bar) — note that the Notebook tab will be grayed out in that case, as Manage Groups is not notebook specific.
